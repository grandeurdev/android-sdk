...
public class Auth {
    ...
    public Call<JsonObject> login(String email, String password) throws Exception {
        ...
        return this.post.send("/auth/loginwithemail", data, null, this.context).clone();
    }
    ...
    public Call<JsonObject> register(String email, String password, String displayName, String phone) throws Exception {
        ...
        return this.post.send("/auth/register", data, null, this.context).clone();
